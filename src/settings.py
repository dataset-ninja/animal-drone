...
##################################
PROJECT_NAME: str = "Animal Drone"
PROJECT_NAME_FULL: str = "Animal Drone"
...
##################################
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = "https://universe.roboflow.com/folio3-krxsh/animal-drone-5gqre/dataset/2/download"
